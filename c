...
<html>
    <head>
        ...
        * Author:         OverAPI
        -->
        <meta charset="utf-8" />
        <title>C Cheat Sheet | OverAPI.com</title>
...
<div id="navbar">
    ...
    <ul id="navlist" class="nav">
        ...
        <li><a href="c#more" id="nav-more">More &raquo;</a></li>
    </ul>
</div>
    ...
    <div class="board board-326">
        ...
        <div class="board-card">
            ...
            <ul>
                ...
                <li><a href="https://overapi.com/static/cs/cs/C.Reference.Card.ANSI.2.2.pdf">ANSI C Quick Reference Card [backup]</a></li>
                <li><a href="https://overapi.com/static/cs/cs/ansi-c-refcard-a4.pdf">ANSI C Quick Reference Card [backup]</a></li>
