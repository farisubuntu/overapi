...
<html>
    <head>
        ...
        * Author:         OverAPI
        -->
        <meta charset="utf-8" />
        <title>SQL Cheat Sheet | OverAPI.com</title>
...
<div id="navbar">
    ...
    <ul id="navlist" class="nav">
        ...
        <li><a href="sql#more" id="nav-more">More &raquo;</a></li>
    </ul>
</div>
...
<div class="loading">
    ...
    <div class="board board-326">
        ...
        <div class="board-card">
            ...
            <ul>
                <li><a href="sql">Official Website</a></li>
                <li><a href="sql">Wolfram Alpha Tools</a></li>
