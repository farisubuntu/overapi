...
<html>
    <head>
        ...
        * Author:         OverAPI
        -->
        <meta charset="utf-8" />
        <title>Ruby Cheat Sheet | OverAPI.com</title>
...
<div id="navbar">
    ...
    <ul id="navlist" class="nav">
        ...
        <li><a href="ruby#more" id="nav-more">More &raquo;</a></li>
    </ul>
</div>
...
<div class="loading">
    ...
    <div class="board">
        ...
        <div class="board-card">
            ...
            <ul>
                ...
                <li><a href="static/cs/Ruby&#32;Language&#32;QuickRef.pdf">Ruby Language QuickRef [.pdf]</a></li>
            </ul>
        </div>
        <div class="board-card">
    ...
    <div class="board">
        <h2 class="board-title">Enumerator</h2>
        <div class="board-card">
            <h3 class="board-card-title">Methods</h3>
            <ul>
    ...
    <div class="board">
        <h2 class="board-title">Process</h2>
        <div class="board-card">
            <h3 class="board-card-title">Methods</h3>
            <ul>
    ...
    <div class="board">
        <h2 class="board-title">Pre-defined</h2>
        <div class="board-card">
            <h3 class="board-card-title">Variables</h3>
            <ul>
                <li>$!</li>
                <li class="tip">The exception information message set by ‘raise’.</li>
                <li>$@</li>
                <li class="tip">Array of backtrace of the last exception thrown.</li>
                <li>$&</li>
                <li class="tip">The string matched by the last successful pattern match in this scope.</li>
                <li>$`</li>
                <li class="tip">The string to the left  of the last successful match.</li>
                <li>$'</li>
                <li class="tip">The string to the right of the last successful match.</li>
                <li>$+</li>
                <li class="tip">The last bracket matched by the last successful match.</li>
                <li>$1</li>
                <li class="tip">The Nth group of the last successful match. May be > 1.</li>
                <li>$~</li>
                <li class="tip">The information about the last match in the current scope.</li>
                <li>$=</li>
                <li class="tip">The flag for case insensitive, nil by default.</li>
                <li>$/</li>
                <li class="tip">The input record separator, newline by default.</li>
                <li>$\</li>
                <li class="tip">The output record separator for the print and IO#write. Default is nil.</li>
                <li>$,</li>
                <li class="tip">The output field separator for the print and Array#join.</li>
                <li>$;</li>
                <li class="tip">The default separator for String#split.</li>
                <li>$.</li>
                <li class="tip">The current input line number of the last file that was read.</li>
                <li>$<</li>
                <li class="tip">The virtual concatenation file of the files given on command line.</li>
                <li>$></li>
                <li class="tip">The default output for print, printf. $stdout by default.</li>
                <li>$_</li>
                <li class="tip">The last input line of string by gets or readline.</li>
                <li>$0</li>
                <li class="tip">Contains the name of the script being executed. May be assignable.</li>
                <li>$*</li>
                <li class="tip">Command line arguments given for the script sans args.</li>
                <li>$$</li>
                <li class="tip">The process number of the Ruby running this script.</li>
                <li>$?</li>
                <li class="tip">The status of the last executed child process.</li>
                <li>$:</li>
                <li class="tip">Load path for scripts and binary modules by load or require.</li>
                <li>$"</li>
                <li class="tip">The array contains the module names loaded by require.</li>
                <li>$DEBUG</li>
                <li class="tip">The status of the -d switch.</li>
                <li>$FILENAME</li>
                <li class="tip">Current input file from $<. Same as $<.filename.</li>
                <li>$LOAD_PATH</li>
                <li class="tip">The alias to the $:.</li>
                <li>$stderr</li>
                <li class="tip">The current standard error output.</li>
                <li>$stdin</li>
                <li class="tip">The current standard input.</li>
                <li>$stdout</li>
                <li class="tip">The current standard output.</li>
                <li>$VERBOSE</li>
                <li class="tip">The verbose flag, which is set by the -v switch.</li>
                <li>$-0</li>
                <li class="tip">The alias to $/</li>
                <li>$-a</li>
                <li class="tip">True if option -a is set. Read-only variable.</li>
                <li>$-d</li>
                <li class="tip">The alias to $DEBUG.</li>
                <li>$-F</li>
                <li class="tip">The alias to $;.</li>
                <li>$-i</li>
                <li class="tip">In in-place-edit mode, this variable holds the extention, otherwise nil.</li>
                <li>$-I</li>
                <li class="tip">The alias to $:.</li>
                <li>$-l</li>
                <li class="tip">True if option -l is set. Read-only variable.</li>
                <li>$-p</li>
                <li class="tip">True if option -p is set. Read-only variable.</li>
                <li>$-v</li>
                <li class="tip">The alias to $VERBOSE.</li>
            </ul>
        </div>
        <div class="board-card">
            <h3 class="board-card-title">Global Constant</h3>
            <ul>
                <li>TRUE</li>
                <li class="tip">The typical true value.</li>
                <li>FALSE</li>
                <li class="tip">The false itself.</li>
                <li>NIL</li>
                <li class="tip">The nil itself.</li>
                <li>STDIN</li>
                <li class="tip">The standard input. The default value for $stdin.</li>
                <li>STDOUT</li>
                <li class="tip">The standard output. The default value for $stdout.</li>
                <li>STDERR</li>
                <li class="tip">The standard error output. The default value for $stderr.</li>
                <li>ENV</li>
                <li class="tip">The hash contains current environment variables.</li>
                <li>ARGF</li>
                <li class="tip">The alias to the $<.</li>
                <li>ARGV</li>
                <li class="tip">The alias to the $*.</li>
                <li>DATA</li>
                <li class="tip">The file object of the script, pointing just after __END__.</li>
                <li>RUBY_VERSION</li>
                <li class="tip">The ruby version string (VERSION was depricated).</li>
                <li>RUBY_RELEASE_DATE</li>
                <li class="tip">The relase date string.</li>
                <li>RUBY_PLATFORM</li>
                <li class="tip">The platform identifier</li>
            </ul>
        </div>
    </div>
</div>
