...
<html>
    <head>
        ...
        * Author:         OverAPI
        -->
        <meta charset="utf-8" />
        <title>Ada Cheat Sheet | OverAPI.com</title>
...
<div id="navbar">
    ...
    <ul id="navlist" class="nav">
        ...
        <li><a href="ada#more" id="nav-more">More &raquo;</a></li>
    </ul>
</div>
...
<div class="loading">
    ...
    <div class="board board-326">
        ...
        <div class="board-card">
            ...
            <ul>
                <li><a href="http://www.dmoz.org/Computers/Programming/Languages/Ada/">Ada Programming</a></li>
                <li><a href="http://www.ada-europe.org/">Ada Europe</a></li>
                <li><a href="http://en.wikipedia.org/wiki/Ada_%28programming_language%29">Wikipedia Ada</a></li>
            </ul>
        </div>
        <div class="board-card">
            ...
            <ul>
                ...
                <li><a href="static/cs/Ada&#32;Reference&#32;Card.pdf">Ada Reference Card by DAINA [backup]</a></li>
                <li><a href="static/cs/Ada&#32;Syntax&#32;Card.pdf">Ada Syntax Card by DAINA [backup]</a></li>
            </ul>
        </div>
    </div>
</div>
