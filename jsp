...
<html>
    <head>
        ...
        * Author:         OverAPI
        -->
        <meta charset="utf-8" />
        <title>JSP Cheat Sheet | OverAPI.com</title>
...
<div id="navbar">
    ...
    <ul id="navlist" class="nav">
        ...
        <li><a href="jsp#more" id="nav-more">More &raquo;</a></li>
    </ul>
</div>
    ...
    <div class="board board-326">
        ...
        <div class="board-card">
            ...
            <ul>
                ...
                <li><a href="static/cs/JSP&#32;Syntax.pdf">JSP Syntax [backup]</a></li>
                <li><a href="http://www.digilife.be/quickreferences/QRC/JSP%20Quick%20Reference%20Card.pdf">JSP Quick Reference Card [.pdf]</a></li>
                <li><a href="static/cs/JSP&#32;Quick&#32;Reference&#32;Card.pdf">JSP Quick Reference Card [backup]</a></li>
