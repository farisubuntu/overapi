...
<html>
    <head>
        ...
        * Author:         OverAPI
        -->
        <meta charset="utf-8" />
        <title>Java Cheat Sheet | OverAPI.com</title>
...
<div id="navbar">
    ...
    <ul id="navlist" class="nav">
        ...
        <li><a href="java#more" id="nav-more">More &raquo;</a></li>
    </ul>
</div>
    ...
    <div class="board">
        ...
        <div class="board-card">
            ...
            <ul>
                ...
                <li><a href="static/cs/JAVA&#32;Programming&#32;Guide&#32;-&#32;Quick&#32;Reference.pdf">JAVA Programming Guide - Quick Reference [.pdf]</a></li>
            </ul>
        </div>
        <div class="board-card">
    ...
    <div class="board">
        ...
        <div class="board-card">
            ...
            <ul>
              ...
              <li><a href="https://overapi.com/java/java_enumeration_interface.htm" title=" This is legacy interface and defines the methods by which you can enumerate (obtain one at a time) the elements in a collection of objects. This legacy interface has been superceded by Iterator.">Enumeration</a></li>
            </ul>
        </div>
