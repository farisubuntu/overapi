...
<html>
    <head>
        ...
        * Author:         OverAPI
        -->
        <meta charset="utf-8" />
        <title>XSL Cheat Sheet | OverAPI.com</title>
...
<div id="navbar">
    ...
    <ul id="navlist" class="nav">
        ...
        <li><a href="xsl#more" id="nav-more">More &raquo;</a></li>
    </ul>
</div>
    ...
    <div class="board board-326">
        ...
        <div class="board-card">
            ...
            <ul>
                ...
                <li><a href="static/cs/Extensible&#32;Stylesheet&#32;Language&#32;(XSL)&#32;1.0.pdf">Extensible Stylesheet Language (XSL) 1.0 by deepx [backup]</a></li>
            </ul>
        </div>
        <div class="board-card">
