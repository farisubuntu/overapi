...
<html>
    <head>
        ...
        * Author:         OverAPI
        -->
        <meta charset="utf-8" />
        <title>Groovy Cheat Sheet | OverAPI.com</title>
...
<div id="navbar">
    ...
    <ul id="navlist" class="nav">
        ...
        <li><a href="groovy#more" id="nav-more">More &raquo;</a></li>
    </ul>
</div>
...
<div class="loading">
    ...
    <div class="board board-326">
        ...
        <div class="board-card">
            ...
            <ul>
                <li><a href="http://groovy.codehaus.org/">Official Website</a></li>
                <li><a href="http://en.wikipedia.org/wiki/Groovy_(programming_language)">Wikipedia Groovy</a></li>
            </ul>
        </div>
        <div class="board-card">
            <h3 class="board-card-title">Download</h3>
            <ul>
                <li><a href="http://refcardz.dzone.com/refcardz/groovy">Groovy by Dierk König [.pdf]</a></li>
            </ul>
        </div>
        <div class="board-card">
